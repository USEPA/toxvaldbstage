...
\end{center}
\inputencoding{utf8}
\ifthenelse{\boolean{Rd@use@hyper}}{\hypersetup{pdftitle = {toxvaldb09: Builds the ToxValDB V9 Database}}}{}
\begin{description}
\raggedright{}
\item[Type]\AsIs{Package}
\item[Title]\AsIs{Builds the ToxValDB V9 Database}
\item[Version]\AsIs{1.0.1}
\item[Author]\AsIs{Aswani Unikrishnan}
\item[Maintainer]\AsIs{Ricahrd Judson }\email{judson.richard@epa.gov}\AsIs{}
\item[Description]\AsIs{The database has 2 main parts - toxval_source containing 
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{clowder\_id\_prep.v2}{Organize the clowder\_id and document\_name information}{clowder.Rul.id.Rul.prep.v2}
%
\begin{Description}\relax
...
\end{Value}
\inputencoding{utf8}
\HeaderA{fill.toxval.defaults.global.by.source}{Set Toxval Defaults globally}{fill.toxval.defaults.global.by.source}
%
\begin{Description}\relax
...
\end{Value}
\inputencoding{utf8}
\HeaderA{fix.non\_ascii.v2}{Flag non ascii characters in the database}{fix.non.Rul.ascii.v2}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import.driver}{Fnction to run all import scripts}{import.driver}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import.source.info.by.source}{Load Source Info for each source into toxval The information is in the file ./dictionary/source\_in\_2020\_aug\_17.xlsx}{import.source.info.by.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_atsdr\_pfas\_2021\_source}{Load atsdr pfas 2021 Source into dev\_toxval\_source\_v4.}{import.Rul.atsdr.Rul.pfas.Rul.2021.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_atsdr\_pfas\_source}{Load atsdr pfas Source files into dev\_toxval\_source\_v3.}{import.Rul.atsdr.Rul.pfas.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_atsdr\_source}{Load atsdr Source into dev\_toxval\_source\_v3.}{import.Rul.atsdr.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_caloehha\_source}{Load caloehha Source file into dev\_toxval\_source\_v4. The raw data can be exported as an Excel sheet from the web site https://oehha.ca.gov/chemicals, selecting the link "Export database as .CSV file"}{import.Rul.caloehha.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_copper\_source}{Load copper manufacturers Source into dev\_toxval\_source\_v4.}{import.Rul.copper.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_cosmos\_source}{Load cosmos Source files into dev\_toxval\_source\_v4.}{import.Rul.cosmos.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_dod\_ered\_source}{Load dod Source into dev\_toxval\_source\_v2.}{import.Rul.dod.Rul.ered.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_doe\_benchmarks\_source}{Load doe\_benchmarks Source into dev\_toxval\_source\_v2.}{import.Rul.doe.Rul.benchmarks.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_doe\_source}{Load doe Source into dev\_toxval\_source\_v4.}{import.Rul.doe.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_echa\_echemportal\_api\_source}{Load ECHA echemportal api Source into dev\_toxval\_source\_v4.}{import.Rul.echa.Rul.echemportal.Rul.api.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_efsa2\_source}{Load efsa2 Source into dev\_toxval\_source\_v2.}{import.Rul.efsa2.Rul.source}
%
\begin{Description}\relax
Load efsa2 Source into dev\_toxval\_source\_v2.
\end{Description}
%
\begin{Usage}
\begin{verbatim}
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_hawc\_pfas\_150\_source}{Load HAWC PFAS 150 Source into dev\_toxval\_source\_v4.}{import.Rul.hawc.Rul.pfas.Rul.150.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_hawc\_pfas\_430\_source}{Load HAWC PFAS 430 Source into dev\_toxval\_source\_v4.}{import.Rul.hawc.Rul.pfas.Rul.430.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_hawc\_source}{Load HAWC Source into dev\_toxval\_source\_v3.}{import.Rul.hawc.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_health\_canada\_source}{Load health\_canada Source Info into dev\_toxval\_source\_v2.}{import.Rul.health.Rul.canada.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_heast\_source}{Load heast Source into dev\_toxval\_source\_v2.}{import.Rul.heast.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_hess\_source}{Load hess Source into dev\_toxval\_source\_v3.}{import.Rul.hess.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_hpvis\_source}{Load hpvis Source Info into dev\_toxval\_source\_v2.}{import.Rul.hpvis.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_iris\_source}{Load IRIS Source into dev\_toxval\_source\_v4.}{import.Rul.iris.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_lanl\_source}{Load lanl Source into dev\_toxval\_source\_v2.}{import.Rul.lanl.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_niosh\_source}{Load niosh Source into dev\_toxval\_source\_v4.}{import.Rul.niosh.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_oppt\_source}{Load oppt Source Info into dev\_toxval\_source\_v2.}{import.Rul.oppt.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_opp\_source}{Load opp Source into dev\_toxval\_source\_v2.}{import.Rul.opp.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_penn\_source}{Load penn Source into dev\_toxval\_source\_v2.}{import.Rul.penn.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_pfas\_150\_sem\_source}{Load PFAS 150 SEM Source data into dev\_toxval\_source\_v2.}{import.Rul.pfas.Rul.150.Rul.sem.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_pfas\_summary\_pods\_source}{Load PFAS Summary PODs into dev\_toxval\_source\_v2.}{import.Rul.pfas.Rul.summary.Rul.pods.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_pprtv\_ncea\_source}{Load pprtv\_ncea Source Info into dev\_toxval\_source\_v2.}{import.Rul.pprtv.Rul.ncea.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_pprtv\_ornl\_source}{Load pprtv\_ornl Source into dev\_toxval\_source\_v2.}{import.Rul.pprtv.Rul.ornl.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_rsl\_source}{Load rsl Source Info into dev\_toxval\_source\_v2.}{import.Rul.rsl.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{import\_test\_source}{Load test Source data into dev\_toxval\_source\_v4.}{import.Rul.test.Rul.source}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{load.dsstox}{Load DSSTox if needed}{load.dsstox}
%
\begin{Description}\relax
...
\end{Value}
\inputencoding{utf8}
\HeaderA{source.size}{print out the dize of each of the tables}{source.size}
%
\begin{Description}\relax
...
\end{Value}
\inputencoding{utf8}
\HeaderA{toxval.init.db}{Initialize the database}{toxval.init.db}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.atsdr}{Load atsdr from toxval\_source to toxval}{toxval.load.atsdr}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.atsdr.pfas}{Load new\_atsdr\_pfas from toxval\_source to toxval}{toxval.load.atsdr.pfas}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.atsdr.pfas.2021}{Load new\_atsdr\_pfas\_2021 from toxval\_source to toxval}{toxval.load.atsdr.pfas.2021}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.cal\_dph}{Load the cal\_dph (old ACToR - flex)data  from toxval sourcedb to toxval}{toxval.load.cal.Rul.dph}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.chiu}{Load new\_chiu from toxval\_source to toxval}{toxval.load.chiu}
%
\begin{Description}\relax
Load new\_chiu from toxval\_source to toxval
\end{Description}
%
\begin{Usage}
\begin{verbatim}
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.copper}{Load new\_copper\_table from toxval\_source to toxval}{toxval.load.copper}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.cosmos}{Load cosmos from source to toxval}{toxval.load.cosmos}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.dod}{Load DOD from toxval\_source to toxval}{toxval.load.dod}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.dod.ered}{Load new\_dod\_table from toxval\_source to toxval}{toxval.load.dod.ered}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.doe.benchmarks}{Load new\_doe\_table and new\_doe\_benchmarks\_table from toxval\_source to toxval}{toxval.load.doe.benchmarks}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.doe.ecorisk}{Load new\_lanl\_table from toxval\_source to toxval}{toxval.load.doe.ecorisk}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.doe.pac}{Load new\_doe\_table and new\_doe\_benchmarks\_table from toxval\_source to toxval}{toxval.load.doe.pac}
%
\begin{Description}\relax
Load new\_doe\_table and new\_doe\_benchmarks\_table from toxval\_source to toxval
\end{Description}
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.echa}{Load ECHA from toxval\_source to toxval}{toxval.load.echa}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.echa.echemportal}{Load ECHA echemportal 2020 (new\_echa)from toxval\_source to toxval}{toxval.load.echa.echemportal}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.echa.echemportal.api}{Load echa\_echemportal\_api from toxval\_source to toxval}{toxval.load.echa.echemportal.api}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.echa.iuclid}{Load ECHA IUCLID data from source}{toxval.load.echa.iuclid}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.echa3}{Load new\_echa3 from toxval\_source to toxval}{toxval.load.echa3}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.ecotox}{Load ECOTOX from toxval\_source to toxval}{toxval.load.ecotox}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.efsa}{Load new\_efsa from toxval\_source to toxval}{toxval.load.efsa}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.efsa2}{Load new\_efsa2 from toxval\_source to toxval}{toxval.load.efsa2}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.envirotox}{Load original\_envirotox from toxval\_source to toxval}{toxval.load.envirotox}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.epa\_aegl}{Load the epa\_aegl (old ACToR - flex)data  from toxval sourcedb to toxval}{toxval.load.epa.Rul.aegl}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.fda\_cedi}{Load the fda\_cedi (old ACToR - flex)data  from toxval sourcedb to toxval}{toxval.load.fda.Rul.cedi}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.healthcanada}{Load new\_health\_canada\_table from toxval\_source to toxval}{toxval.load.healthcanada}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.heast}{Load new\_heast\_table and new\_heast\_rfd\_rfc\_table from toxval\_source to toxval}{toxval.load.heast}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.hess}{Load hess from toxval\_source to toxval}{toxval.load.hess}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.penn}{Load new\_penn\_table from toxval\_source to toxval}{toxval.load.penn}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.pprtv.ncea}{Load pprtv from dev\_pprtv to toxval There is a known bug here - some of the POD values are repeated because they produce two kinds of RfD values (chronic and subchronic) - dealing with htis will require some work}{toxval.load.pprtv.ncea}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.pprtv.ornl}{Load new\_pprtv\_ornl from toxval\_source to toxval}{toxval.load.pprtv.ornl}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.rsl}{Load the RSL data - the source database needs to be updated periodically}{toxval.load.rsl}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.test}{Load new\_test\_table from toxval\_source to toxval}{toxval.load.test}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.usgs\_hbsl}{Load the usgs\_hbsl (old ACToR - flex)data  from toxval sourcedb to toxval}{toxval.load.usgs.Rul.hbsl}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.load.who\_ipcs}{Load the who\_ipcs (old ACToR - flex)data  from toxval sourcedb to toxval}{toxval.load.who.Rul.ipcs}
%
\begin{Description}\relax
...
\end{Arguments}
\inputencoding{utf8}
\HeaderA{toxval.set.mw}{Set teh moleculr weight in the toxval table}{toxval.set.mw}
%
\begin{Description}\relax
