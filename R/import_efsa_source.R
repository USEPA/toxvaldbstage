...
#' @export
#--------------------------------------------------------------------------------------
import_efsa_source <- function(toxval.db){
  ...
  points <- read.csv("./efsa/efsa_files/ReferencePoints_KJ_2020.csv", fileEncoding = "UTF-8", stringsAsFactors = F)
  chems <- read.csv("./efsa/efsa_files/SubstanceCharacterisation_KJ_2020.csv", fileEncoding = "UTF-8", stringsAsFactors = F)
  values <- read.csv("./efsa/efsa_files/ReferenceValues_KJ_2020.csv", fileEncoding = "UTF-8", stringsAsFactors = F)
  details <- read.csv("./efsa/efsa_files/EFSAOutputs_KJ_2020.csv", fileEncoding = "UTF-8", stringsAsFactors = F)
  ...
  write.xlsx(total, "./efsa/efsa_files/new_EFSA_combined.xlsx", row.names = FALSE, quote=FALSE)
  runInsertTable(total,"new_efsa",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(chemical_information,"efsa_chemical_information",toxval.db,do.halt=T,verbose=F)
