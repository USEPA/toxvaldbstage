...
import_opp_source <- function(toxval.db,infile) {
  ...
  #print(names(res))
  runInsertTable(res,"original_opp_table",toxval.db,do.halt=T,verbose=F)
  ...
  #runInsertTable(res1,"whole_opp_table",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(chemical_information,"opp_chemical_information",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(opp_types,"new_opp_table",toxval.db,do.halt=T,verbose=F)
