...
import_echa3_source <- function(toxval.db,infile, dict_toxval_units, dict_toxval_type,dict_study_type,
  ...
  dict <- read.xlsx(dict_toxval_units)
  ...
  dict <- read.xlsx(dict_toxval_type)
  ...
  dict <- read.xlsx(dict_study_type)
  ...
  dict <- read.xlsx(dict_exposure_route)
  ...
  dict <- read.xlsx(dict_exposure_method)
  ...
  dict <- read.xlsx(dict_study_duration)
  ...
  dict <- read.xlsx(dict_critical_effects)
