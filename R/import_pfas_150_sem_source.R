...
import_pfas_150_sem_source <- function(toxval.db,infile) {
  printCurrentFunction(toxval.db)

  #####################################################################
  cat("Build original_pfas_150_sem\n")
  #####################################################################
  res <- read.xlsx(infile,4)
  ...
  runInsertTable(res2,"original_pfas_150_sem",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res4,"new_pfas_150_sem",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(chemical_information,"pfas_150_sem_chemical_information",toxval.db,do.halt=T,verbose=F)
