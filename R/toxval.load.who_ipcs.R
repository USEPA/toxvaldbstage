...
toxval.load.who_ipcs <- function(toxval.db, source.db,log=F){
  ...
  res$source_url = "https://apps.who.int/iris/bitstream/handle/10665/44271/9789241547963_eng.pdf?sequence=1&isAllowed=y"
  res$subsource_url = "-"
  res$details_text = paste(source,"Details")
  ...
  cat("pull out record source to refs\n")
  #####################################################################
  refs <- res[,c("toxval_id","source","source_url","long_ref")]
