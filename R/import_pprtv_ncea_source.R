...
import_pprtv_ncea_source <- function(toxval.db,filepath, csvfile, scrapepath) {
  ...
  runInsertTable(colnames_res_to_change, "pprtv_ncea_modified_colnames",toxval.db,do.halt=T,verbose=F )
  ...
  new_pprtv_ncea <- runQuery(query2, toxval.db)
  ...
  runInsertTable(new_pprtv_ncea, "new_pprtv_ncea",toxval.db,do.halt=T,verbose=F )
  ...
  runInsertTable(chemical_information,"pprtv_ncea_chemical_information",toxval.db,do.halt=T,verbose=F)
