...
#' @export
#--------------------------------------------------------------------------------------
toxval.load.dod.ered <- function(toxval.db,source.db,verbose=F) {
  ...
  query <- "select * from original_dod_ered_table"
  ...
  print(names(res))
  names.list <- c("source_hash","study_type","species_original","name","casrn","media","exposure_route","exposure_conc","exposure_units" ,          
                  "study_duration","risk","test_tissue_type","critical_effect","toxval_numeric","toxval_numeric_qualifier","toxval_units","toxval_type","long_ref","year","lifestage",
                  ...
                  "toxval_numeric_original","toxval_numeric_qualifier_original","toxval_units_original","toxval_type_original","study_duration_value_original","study_duration_units_original","document_name")
  ...
  names.list <- c("source_hash","study_type","species_original","lifestage","name","casrn","media","exposure_route" ,
                  ...
                  "subsource","source_url","document_name")
  ...
  #####################################################################
  refs <- res[,c("toxval_id","source","long_ref","source_url","year","document_name")]
  names(refs)[4] <- "url"
  ...
  #####################################################################
  res <- res[,!is.element(names(res),c("long_ref","document_name"))]
  #####################################################################
