...
#' @param filepath The path for all the input xlsx files ./atsdr_pfas_2021/atsdr_pfas_2021_files

#--------------------------------------------------------------------------------------

import_atsdr_pfas_2021_source <- function(toxval.db,filepath) {
  printCurrentFunction(toxval.db)
  
  #####################################################################
  cat("Build list of dataframes with all 6 ATSDR_TP_2021 files\n")
  #####################################################################
  files.list <- list.files(filepath,pattern = "ATSDR_TP_2021.*.xlsx")
  ...
  runInsertTable(res1,"atsdr_tp_2021_perfluoroalkyls_oral",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res2,"atsdr_tp_2021_pfna_inhalation",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res3,"atsdr_tp_2021_pfoa_dermal",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res4,"atsdr_tp_2021_pfoa_inhalation",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res5,"atsdr_tp_2021_pfoa_oral",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res6,"atsdr_tp_2021_pfos_oral",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(new_res,"new_atsdr_pfas_2021",toxval.db,do.halt=T,verbose=F)
  #####################################################################
  cat("Build atsdr_pfas_2021_chemical_information table from new_res\n")
  #####################################################################
  ...
  runInsertTable(chemical_information,"atsdr_pfas_2021_chemical_information",toxval.db,do.halt=T,verbose=F)
