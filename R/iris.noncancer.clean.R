...
#--------------------------------------------------------------------------------------
iris.noncancer.clean = function(sys.date="2022-10-21"){
  printCurrentFunction()

  infile1 = paste0(toxval.config()$datapath,"iris/iris_files/iris_scrape_rfd_rfc ",sys.date,".xlsx")
  infile2 = paste0(toxval.config()$datapath,"iris/iris_files/iris_scrape_woe ",sys.date,".xlsx")
  ...
  file = paste0(toxval.config()$datapath,"iris/iris_files/IRIS_non_cancer_clean ",sys.date,".xlsx")
  write.xlsx(iris_non_cancer_clean, file)
