...
#--------------------------------------------------------------------------------------
toxval.load.mass_mmcl <- function(toxval.db, source.db,log=F){
  ...
  res$source_url = "https://www.mass.gov/guides/drinking-water-standards-and-guidelines"
  res$subsource_url = "-"
  res$details_text = paste(source,"Details")
