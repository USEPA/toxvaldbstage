...
#'
#' File from clowder linking clowder_ids to document_names, generated by Taylor Wall
#' clowder_doc_maps_20220608.xlsx

#--------------------------------------------------------------------------------------
clowder_id_prep.v3 <- function(db="dev_toxval_v9",
                               indir="../clowder_v3/") {
  printCurrentFunction(db)

  file1 = paste0(indir,"toxval_v8_record_source_hash_to_clowder_id.xlsx")
  file2 = paste0(indir,"clowder_doc_maps_20220608.xlsx")
