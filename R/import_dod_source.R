#--------------------------------------------------------------------------------------
#' Load DOD MEG to toxval_source. The file to be laoded are in ./dod/dod_files
#' 
#' @param source.db The version of toxval_source into which the tables are loaded.
#' @export
#-------------------------------------------------------------------------------------
import_dod_source = function(source.db) {
  printCurrentFunction(source.db)
  #Air-long-term
  read.xlsx(paste0(toxval.config()$datapath,"dod/dod_files/DOD_Air-MEGs_Long-Term_2013.xlsx")) -> mat
  ...
  #Air-short-term
  read.xlsx(paste0(toxval.config()$datapath,"dod/dod_files/DOD_Air-MEGS_Short-Term_2013.xlsx")) -> mat
  ...
  #Soil
  read.xlsx(paste0(toxval.config()$datapath,"dod/dod_files/DOD_Soil-MEGs_2013.xlsx")) -> mat
  ...
  #Water Long-term
  read.xlsx(paste0(toxval.config()$datapath,"dod/dod_files/DOD_Water-MEGS_Long-Term_2013.xlsx")) -> mat
  mat = mat[3:nrow(mat),c(2:3,7:8)]
  names(mat) = c("casrn", "name","numeric","subsource")
  mat$id = 1:nrow(mat)
  mat = mat[!is.na(mat$numeric),]
  ...
  #Water Short-term
  read.xlsx(paste0(toxval.config()$datapath,"dod/dod_files/DOD_Water-MEGs_Short-Term_2013.xlsx")) -> mat
  ...
  runInsertTable(mat, "dod_meg_2013",source.db)
}
