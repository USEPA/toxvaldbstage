...
iris.scraper = function(){
  ...
  file = paste0(toxval.config()$datapath,"iris/iris_files/iris_scrape_rfd_rfc ",Sys.Date(),".xlsx")
  write.xlsx(rfd.rfc,file)
  file = paste0(toxval.config()$datapath,"iris/iris_files/iris_scrape_woe ",Sys.Date(),".xlsx")
  write.xlsx(woe,file)
