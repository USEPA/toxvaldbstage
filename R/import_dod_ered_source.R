...
# #####################################################################
# source = "DOD ERED"
# res = as.data.frame(dod_table)
# res = res[!is.element(res$casrn,"N/A"),]
# res$clowder_id = "-"
...
#   #####################################################################
#   toxval_source.hash.and.load(db,source,"original_dod_ered_table",F,F,res)
#   browser()
#   return(1)
#
#   res1 <- runQuery("select * from original_dod_ered_table",db)
#   #print(View(res1))
#
#
#   #####################################################################
...
#
#   runInsertTable(chemical_information,"dod_ered_chemical_information",db,do.halt=T,verbose=F)
#
#   #####################################################################
...
#
#   runInsertTable(field_descriptions,"dod_ered_field_descriptions",db,do.halt=T,verbose=F)
#
#   #####################################################################
...
#   }
#
#   runInsertTable(key_description,"dod_ered_key_descriptions",db,do.halt=T,verbose=F)
#
#   #####################################################################
...
#   #print(names(new_dod))
#   #print(View(new_dod))
#   runInsertTable(new_dod,"new_dod_ered_table",db,do.halt=T,verbose=F)
#
#
# }
#
