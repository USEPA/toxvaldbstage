...
import_hawc_pfas_430_source <- function(db,
  ...
  res = as.data.frame(hawc_pfas_430_final)
  res$clowder_id = "-"
  ...
  toxval_source.hash.and.load(db,source,"original_hawc_pfas_430",F,F,res)
  browser()
  return(1)


  runInsertTable(hawc_pfas_430_final,"original_hawc_pfas_430",db,do.halt=T,verbose=F)
  ...
  #runInsertTable(new_res2,"new_hawc_pfas_430",db,do.halt=T,verbose=F)
  ...
  #runInsertTable(chemical_information,"hawc_pfas_430_chemical_information",db,do.halt=T,verbose=F)
