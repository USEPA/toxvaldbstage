...
import_hawc_pfas_430_source <- function(db,
  ...
  infile1 = paste0(toxval.config()$datapath,"hawc_pfas_430/hawc_pfas_430_files/",infile1)
  infile2 = paste0(toxval.config()$datapath,"hawc_pfas_430/hawc_pfas_430_files/",infile2)
  infile3 = paste0(toxval.config()$datapath,"hawc_pfas_430/hawc_pfas_430_files/",infile3)
  #####################################################################
...
##################################################################################
  ...
  hawc_pfas_430$doses <- doses$dose[match(hawc_pfas_430$animal_group.dosing_regime.id,doses$dose_regime)]
  hawc_pfas_430$doses_units <- doses$dose_units.name[match(hawc_pfas_430$animal_group.dosing_regime.id,doses$dose_regime)]

  # Fix NOEL dict
  noel_dict = dose_dict_orig %>%
    left_join(hawc_pfas_430 %>%
  ...
  hawc_pfas_430$NOEL_values <- noel_values$dose[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$NOEL),
                                                      paste(noel_values$dose_regime,noel_values$NOEL))]
  hawc_pfas_430$NOEL_units <-  noel_values$dose_units.name[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$NOEL),
                                                                 paste(noel_values$dose_regime,noel_values$NOEL))]
  hawc_pfas_430$LOEL_values <- loel_values$dose[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$LOEL),
                                                      paste(loel_values$dose_regime,loel_values$LOEL))]
  hawc_pfas_430$LOEL_units <-  loel_values$dose_units.name[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$LOEL),
                                                                 paste(loel_values$dose_regime,loel_values$LOEL))]
  hawc_pfas_430$FEL_values <- fel_values$dose[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$FEL),
                                                    paste(fel_values$dose_regime,fel_values$FEL))]
  hawc_pfas_430$FEL_units <-  fel_values$dose_units.name[match(paste(hawc_pfas_430$animal_group.dosing_regime.id,hawc_pfas_430$FEL),
                                                               paste(fel_values$dose_regime,fel_values$FEL))]
  ...
  hawc_pfas_430_final$study_duration_value <- hawc_pfas_430_final$exposure_duration_value
  ...
  hawc_pfas_430_final = hawc_pfas_430_final %>%
