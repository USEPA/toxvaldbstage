...
#--------------------------------------------------------------------------------------
toxval.load.penn_dep <- function(toxval.db, source.db,log=F){
  ...
  res$source_url = "https://files.dep.state.pa.us/water/bsdw/Noncommunity_Water_Systems/MCL%20PDF.pdf"
  res$subsource_url = "-"
  res$details_text = paste(source,"Details")
