...
import_doe_benchmarks_source <- function(db,
  ...
  toxval_source.hash.and.load(db,source,"original_doe_benchmarks_table",F,F,res)
  browser()
  return(1)
  ...
  # toxval_source.hash.and.load(db,source,"original_doe_benchmarks_table",F,F,res)
  #
  # ###runInsertTable(res,"original_doe_benchmarks_table",db,do.halt=T,verbose=F)
  #
  # browser()
  # return(1)
  ...
  runInsertTable(res1,"whole_doe_benchmarks_table",db,do.halt=T,verbose=F)
  ...
  runInsertTable(chemical_information,"doe_benchmarks_chemical_information",db,do.halt=T,verbose=F)
  ...
  runInsertTable(doe_benchmarks_types,"new_doe_benchmarks_table",db,do.halt=T,verbose=F)
