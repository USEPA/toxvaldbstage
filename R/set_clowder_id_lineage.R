...
set_clowder_id_lineage <- function(source_table,
  ...
  if(is.null(map_file)){
    ...
    map_file = switch(source_table,
                      ...
                      "source_who_ipcs" = data.frame(clowder_id = "65de5b96e4b063812d6afb23",
                                                     document_name = "source_who_ipcs_2019-1-1_extraction_documents.zip"),
                      ...
                      "source_fda_cedi" = data.frame(clowder_id = "65807a74e4b063812d59e209",
                                                     document_name = "source_fda_cedi_20231117.csv"),
    ...
    res <- switch(source_table,
                  ...
                  "source_caloehha" = {
                    ...
                    res2 <- res %>%
                      ...
                      dplyr::filter(!is.na(clowder_id)) %>%
                      dplyr::select(name, source_hash, source_version_date, clowder_id, fk_doc_id)
                  ...
                  "source_hawc" = {
                    ...
                    map_file$animal_group.experiment.study.id = as.character(map_file$animal_group.experiment.study.id)
                    res <- res %>%
                      dplyr::left_join(map_file %>%
                                         dplyr::filter(!is.na(clowder_id)) %>%
