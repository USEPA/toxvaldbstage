...
set_clowder_id_lineage <- function(source_table,
  ...
  if(is.null(map_file)){
    ...
    map_file = switch(source_table,
                      ...
                      "source_who_ipcs" = data.frame(clowder_id = c("64b6e0a5e4b08a6b5a3adf7a",
                                                                    "64b6e0a3e4b08a6b5a3adf63",
                                                                    "64b6e0a3e4b08a6b5a3adf5f"),
                                        document_name = c("who_ipcs_2019.pdf",
                                                          "who_ipcs_2019_corrigenda_August_2020.pdf",
                                                          "who_ipcs_2019_corrigenda_June_2021.pdf")),
