...
#' @export
#--------------------------------------------------------------------------------------
toxval.load.atsdr.pfas.2021 <- function(toxval.db,source.db, verbose=F){
  ...
  #####################################################################
  query <- "select source_hash,casrn,name,source_url,subsource,sex,toxval_numeric,toxval_units,
  critical_effect_original,long_ref,exposure_route_original,exposure_route,study_type_original,study_type,
  species,strain_original,strain,sex_original,document_name,exposure_method_original, exposure_method, 
  study_duration_value_original,study_duration_units_original,study_duration_value,study_duration_units,
  critical_effect,year, toxval_type,exposure_form_original, exposure_form from new_atsdr_pfas_2021" 
  ...
  #####################################################################
  refs <- res[,c("toxval_id","source","year","document_name","long_ref")]
