...
import_hawc_pfas_150_source <- function(toxval.db,infile1,infile2,infile3) {
  ...
  runInsertTable(hawc_pfas_150_final,"original_hawc_pfas_150",toxval.db,do.halt=T,verbose=F)
  ...
  #runInsertTable(new_res2,"new_hawc_pfas_150",toxval.db,do.halt=T,verbose=F)
  ...
  #runInsertTable(chemical_information,"hawc_pfas_150_chemical_information",toxval.db,do.halt=T,verbose=F)
