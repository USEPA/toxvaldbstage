...
import_penn_source <- function(toxval.db,infile) {
  ...
  runInsertTable(res,"original_penn_table",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(penn_key,"penn_key_descriptions",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(res1,"whole_penn_table",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(chemical_information,"penn_chemical_information",toxval.db,do.halt=T,verbose=F)
  ...
  runInsertTable(penn_types,"new_penn_table",toxval.db,do.halt=T,verbose=F)
  ...
  #res2 <- res2[!res2_var]
  #runInsertTable(res2,"new_penn_table",toxval.db,do.halt=T,verbose=F)
